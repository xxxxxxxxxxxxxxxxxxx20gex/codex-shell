...
export function useAgentSession(
  ...
  useEffect(() => {
    ...
    return subscribeToSessionEvents(client, {
      ...
      onThreadName,
      onThreadSettings: (notification) => dispatch({ type: "threadSettingsUpdated", notification }),
      onThreadGoalUpdated: (notification) => dispatch({ type: "threadGoalUpdated", notification }),
      onThreadGoalCleared: (notification) => dispatch({ type: "threadGoalCleared", threadId: notification.threadId }),
      onThreadStarted,
      onThreadStatus,
  ...
  return {
    ...
    threadSettings: sessionState.threadSettings,
    threadGoal: sessionState.threadGoal,
    processEventsByTurnId: sessionState.processEventsByTurnId,
    error,
