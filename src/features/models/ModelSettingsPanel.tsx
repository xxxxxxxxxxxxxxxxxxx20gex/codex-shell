    ...
    <div className="modal-backdrop" onMouseDown={() => { if (!saving) onClose(); }}>
      <section className="settings-modal" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <div className="settings-body" inert={saving}>
          ...
          {catalogApplies && providerCapabilities && <div className="template-detail"><div><strong>Provider 能力</strong></div><small>{providerCapabilities.webSearch ? "Web Search" : "无 Web Search"} · {providerCapabilities.imageGeneration ? "Image Generation" : "无图片生成"} · {providerCapabilities.namespaceTools ? "Namespace Tools" : "无 Namespace Tools"}</small></div>}
