...
describe("conversation timing", () => {
  ...
  it("collapses completed intermediate activity after the final answer", () => {
    ...
    const answer: ThreadItem = { type: "agentMessage", id: "answer-complete", text: "最终回答", phase: "final_answer", memoryCitation: null, questions: null, delivery: null };
  ...
  it("groups commentary and reasoning outside the final answer", () => {
    const commentary: ThreadItem = { type: "agentMessage", id: "commentary-1", text: "我先检查项目结构。", phase: "commentary", memoryCitation: null, questions: null, delivery: null };
  ...
  it("keeps steered user messages in their native item order", () => {
    ...
    const answer: ThreadItem = { type: "agentMessage", id: "answer-steered", text: "检查完成", phase: "final_answer", memoryCitation: null, questions: null, delivery: null };
  ...
  it("uses a minimal assistant accent and summarizes file changes at the end", () => {
    const firstAgent: ThreadItem = { type: "agentMessage", id: "agent-1", text: "第一段", phase: null, memoryCitation: null, questions: null, delivery: null };
    const secondAgent: ThreadItem = { type: "agentMessage", id: "agent-2", text: "第二段", phase: null, memoryCitation: null, questions: null, delivery: null };
