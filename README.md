...
当前公开稳定版为 [Codex Shell v0.1.6](https://github.com/xxxxxxxxxxxxxxxxxxx20gex/codex-shell/releases/tag/v0.1.6)：下载
`codex-shell_0.1.6_x64-setup.exe` 后按向导安装。`v0.1.6` 已启用 Tauri Updater，但当前公开 Release 未进行 Windows Authenticode 代码签名，
...
当前 `v0.1.6` Windows 安装包使用 Tauri Updater 的 minisign 更新签名校验；安装包本身
...
- `main`：个人项目的日常开发与稳定主线；
- `release/vX.Y.Z`：对应已发布版本的冻结维护分支，并与同名 Git tag 对齐；当前公开版本为 `release/v0.1.6`。Updater 已在当前发布分支中生效。
