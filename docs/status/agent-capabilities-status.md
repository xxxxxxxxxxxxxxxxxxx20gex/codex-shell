...
- 插件详情定向验证（2026-09-17 至 2026-09-18）：真实 Runtime 探针验证未注册市场的安装前详情、三个 Skill 路径与内容读取，以及安装后的禁用、重新读取和启用。组件测试覆盖预览无安装副作用、正文读取、有效开关状态和读写失败；四视口浏览器验证详情、内容滚动、开关、关闭与焦点恢复。未进行真实 WebView2 人工点击验收。
