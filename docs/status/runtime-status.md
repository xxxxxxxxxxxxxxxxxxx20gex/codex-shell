...
- 发布状态：2026-09-11，v0.1.5 生产安装器（上一版）沿用 codex-cli 0.153.4 与三个同源 helper，哈希与 manifest 一致；Updater 公钥未更换，安装器已通过 minisign 验签，三项 GitHub 资产已上传并逐项核对 SHA-256，正式发布为 Latest。本次未重复 v0.1.4 的干净 Windows 环境 UAC 与 elevated 执行验收。
